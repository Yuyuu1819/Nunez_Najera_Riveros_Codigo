...
class SimpsonApp(tk.Tk):
    ...
    def _build_layout(self):
        ...
        tk.Label(top, text="CETYS Universidad — Métodos Numéricos",
                 font=("Segoe UI", 10),
    ...
    def _build_left_panel(self, parent):
        ...
        self._card_simple = self._make_result_card(
            results_frame, "Simpson 1/3  Simple", "n = 2  (3 puntos)", GREEN)
