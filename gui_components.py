...
# Asegúrate de tener este archivo 'numerical_engine.py' en la misma carpeta
...
class SimpsonApp(tk.Tk):
    ...
    def _calcular(self):
        try:
            ...
            messagebox.showerror("Error de entrada", "a, b deben ser números y n un entero.")
            return
        ...
        if n <= 0:
            ...
            return
        if n % 2 != 0:
            messagebox.showerror("Error de entrada", "Para el método de Simpson 1/3, n debe ser un número par.")
            return
